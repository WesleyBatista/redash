...
FILES_BASE_URL=https://raw.githubusercontent.com/easytaxibr/redash/docs_setup/setup/files/
...
LATEST_URL="https://github.com/easytaxibr/redash/releases/download/v${REDASH_VERSION}/redash.$REDASH_VERSION.tar.gz"
